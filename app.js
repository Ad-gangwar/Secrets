...
passport.use(new GoogleStrategy({
    ...
    // userProfileURL:"https://www.googleapis.com/oauth2/userinfo"
...
// passport.serializeUser(userModel.serializeUser()); not working 
...
app.post("/submit", function(req, res){
    ...
    userModel.findById(req.user._id).then(function(foundUser){
...
app.post("/register", function(req, res){
    ...
    //     newUser.save().then(function(detail){
    //         if(detail){
    //             res.render("secrets");
    //         }
    //     }).catch(function(err){
